...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO crud (user, book, page, category, deskripsi) VALUES ('$user', '$book_name', '$number_of_chapters', '$book_category', '$deskripsi')";
      ...
      <div class="container d-flex justify-content-center">
         <form action="" method="post" style="width:50vw; min-width:300px;">
            ...
            <div class="mb-3">
               ...
               <input type="text" class="form-control" name="deskripsi" placeholder="buku ini tentang">
            </div>
